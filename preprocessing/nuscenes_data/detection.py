...
parser.add_argument('--detection_folder', type=str, default='data/nusc_preprocessed')
...
def main(det_name, file_name, detection_folder, data_folder, mode):
    ...
    raw_file_path = os.path.join(detection_folder, det_name, file_name)
    output_folder = os.path.join(data_folder, 'detections', det_name, 'dets')
