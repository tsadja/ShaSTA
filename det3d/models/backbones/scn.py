...
class SpMiddleResNetFHD(nn.Module):
    ...
    def forward(self, voxel_features, coors, batch_size, input_shape):
        ...
        # logger.info('voxel_features: {}'.format(voxel_features.shape))
        # logger.info('voxel_features data type: {}'.format(voxel_features.dtype))
        # logger.info('coors: {}'.format(coors.shape))
        # logger.info('coors data type: {}'.format(coors.dtype))
        # logger.info('batch_size: {}'.format(batch_size))
        # logger.info('input_shape: {}'.format(type(input_shape)))
        # logger.info('input_shape: {}'.format(input_shape.shape))
        # print('voxel_features: {}'.format(voxel_features.shape))
        # print('voxel_features data type: {}'.format(voxel_features.dtype))
        # print('coors: {}'.format(coors.shape))
        # print('coors data type: {}'.format(coors.dtype))
        # print('batch_size: {}'.format(batch_size))
        # print('input_shape: {}'.format(type(input_shape)))
        # print('input_shape: {}'.format(input_shape.shape))
        # input: # [41, 1600, 1408]
        sparse_shape = np.array(input_shape[::-1]) + [1, 0, 0]
        # logger.info('sparse_shape: {}'.format(sparse_shape.shape))
        ...
        # logger.info('ret: {}'.format(ret.shape))
        ...
        # logger.info('ret reshaped: {}'.format(ret.shape))
